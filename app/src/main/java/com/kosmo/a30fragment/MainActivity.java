...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //프레그먼트 교체를 위한 매니저 객체 생성 및 트랜잭션 객체 생성
        ...
        Bundle객체의 사용법은 Map컬렉션과 거의 유사하다.
        Key와 Value로 구성된다.
         */
        ...
        /*
        앱을 처음 실행할때 fragment1을 bottomLayout에 즉시 적용한다.
    ...
    /*
    프레그먼트1은 내부클래스로 정의한다.
    프레그먼트 정의시 별도의 클래스로 정의하는 방법과 내부클래스로 정의하는 방법
    2가지 모두 사용할 수 있다.
    별도로 제작할 경우 Fragment클래스를 상속한 후 onCreateView()메서드를 오버라이딩 한다.
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    사용할 수 있다. setArguments()로 보내면 getArguments()로 받아서 사용한다.
                     */
